    ...
    public static void main(String[] args) {
        ...
        if (bebasKompen.equalsIgnoreCase("Ya")) {
            if (bimbinganP1 >= 8 && bimbinganP2 >=4) {
                ...
                pesan = "Gagal1! Log bimbingan P1 belum mencapai 8 kali";
            } else {
                pesan = "Gagal1! Log bimbingan P2 belum mencapai 4 kali";
            }
        }else {
            pesan = "Gagal1! Mahasiswa masih memiliki tanggungan kompen";
        }
